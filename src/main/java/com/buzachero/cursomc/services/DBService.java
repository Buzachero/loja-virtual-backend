...
import com.buzachero.cursomc.domain.Pagamento;
import com.buzachero.cursomc.domain.PagamentoComBoleto;
import com.buzachero.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Henrique Buzachero", "henriquebuzachero@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA, bcpe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Eliza", "anaeliza@gmail.com", "79868381088", TipoCliente.PESSOA_FISICA, bcpe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("273621312", "938385552"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "38777211", cli2, c2);
